...
public class LogicalReasoningQuizPage {
	
WebDriver ldriver;
	
	public LogicalReasoningQuizPage(WebDriver rdriver)
	{
		ldriver = rdriver;
	...
	@FindBy(how=How.XPATH, using ="//a[contains(@href,'#Logical-Reasoning')]")
	WebElement LogicalReasoningTest;
	...
	@FindAll(@FindBy(how = How.XPATH, using = "//div//h3[text()='Logical Reasoning']/following-sibling::div//a//div"))
    private List<WebElement> elements;

	
	
	public void clickLogicalReasoningTest() throws Exception
	{
		Thread.sleep(1500);
		LogicalReasoningTest.click();
	}
