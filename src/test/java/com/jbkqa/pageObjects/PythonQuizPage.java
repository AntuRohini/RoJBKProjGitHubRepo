...
public class PythonQuizPage {
	
WebDriver ldriver;
	
	public PythonQuizPage(WebDriver rdriver)
	{
		ldriver = rdriver;
		PageFactory.initElements(rdriver,this);
	}
	
	@FindBy(how=How.XPATH, using ="//a[contains(@href,'#Python')]")
	WebElement PythonTest;
	...
	@FindAll(@FindBy(how = How.XPATH, using = "//div//h3[text()='Python']/following-sibling::div//a//div"))
    private List<WebElement> elements;

	
	
	public void clickPythonTest() throws Exception
	{
		Thread.sleep(1500);
		PythonTest.click();
	}
