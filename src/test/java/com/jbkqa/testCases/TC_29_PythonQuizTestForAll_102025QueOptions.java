...
public class TC_29_PythonQuizTestForAll_102025QueOptions extends BaseClass{
	
	@Test
	public void PythonQuizTest()
	{
			     ...
			     for(int i=a;i<takeQuiz.size();i++)
			      {
				    ...
				    for(int k=b;k<radio.size();k++)
					{
						...
						test.info("Python quiz started for "+value+" questions.");
						...
						if(value.equalsIgnoreCase("10"))
						 {
						    ...
						    System.out.println("Python QUIZ start for 10 question: "+pythonquiz);
						    test.info("Python QUIZ start for 10 question: "+pythonquiz);
						    ...
						    try
							{
								...
								if(error==true)
								{
									captureScreenshot(driver,pythonquiz+value+"_Python_NoQueFound");
							...
							}catch(Exception ElementNotInteractableException)
							{
								...
								for(int j=1;j<=num1-1;j++)
								{
								   ...
								   int numQue = Integer.parseInt(queCount);
								     if(numQue!=10)
								       {
									      captureScreenshot(driver,pythonquiz+"_Python_10QueQuizSubmittedFor_"+queCount+"_que");
									      test.fail("Python Quiz submitted for less than 10 questions. No of question found: "+queCount);
				  				       }
								     else 
								       {
								          test.pass("Python quiz Test Pass for all "+queCount+" questions")	;
								       }
								     pythonQuiz.closeQuizWindow();
								     Thread.sleep(1500);
						...
						if(value.equalsIgnoreCase("20"))
						 {
						    ...
						    Thread.sleep(1500);
						    String pythonquiz = quizName.get(i).getText();
						    System.out.println("Python QUIZ start for 20 question: "+pythonquiz);
						    test.info("Python QUIZ start for 20 question: "+pythonquiz);
							...
							}catch(Exception ElementNotInteractableException)
							{
								...
								for(int j=1;j<=num1-1;j++)
								{
								   ...
								   int numQue = Integer.parseInt(queCount);
								     if(numQue!=20)
								       {
									      captureScreenshot(driver,pythonquiz+"_Python_20QueQuizSubmittedFor_"+queCount+"_que");
									      test.fail("Python Quiz submitted for less than 20 questions. No of question found: "+queCount);
				  				       }
								     else 
								       {
						...
						if(value.equalsIgnoreCase("25"))
						 {
						    ...
						    Thread.sleep(1500);
						    String pythonquiz = quizName.get(i).getText();
						    System.out.println("Python QUIZ start for 25 question: "+pythonquiz);
						    test.info("Python QUIZ start for 25 question: "+pythonquiz);
							...
							}catch(Exception ElementNotInteractableException)
							{
								...
								for(int j=1;j<=num1-1;j++)
								{
								   ...
								   int numQue = Integer.parseInt(queCount);
								     if(numQue!=25)
								       {
									      captureScreenshot(driver,pythonquiz+"_Python_25QueQuizSubmittedFor_"+queCount+"_que");
									      test.fail("Python Quiz submitted for less than 25 questions. No of question found: "+queCount);
				  				       }
								     else 
								       {
								          test.pass("Python Test Pass for all "+queCount+" questions")	;
