...
public class JavaCertificationQuizPage {
	
WebDriver ldriver;
	
	public JavaCertificationQuizPage(WebDriver rdriver)
	{
		ldriver = rdriver;
		PageFactory.initElements(rdriver,this);
	}
	@FindBy(how=How.XPATH, using ="//a[contains(@href,'#Java-Certification')]")
	WebElement JavaCertification;
	...
	@FindAll(@FindBy(how = How.XPATH, using = "//div//h3[text()='Java Certification']/following-sibling::div//a//div"))
    private List<WebElement> elements;

	
	
	public void clickJavaCertification() throws Exception
	{
		Thread.sleep(1500);
		JavaCertification.click();
	}
