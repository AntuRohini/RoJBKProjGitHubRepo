...
public class VerbalTestQuizPage {
	
WebDriver ldriver;
	
	public VerbalTestQuizPage(WebDriver rdriver)
	{
		ldriver = rdriver;
	...
	@FindBy(how=How.XPATH, using ="//a[contains(@href,'#Verbal-Test')]")
	WebElement VerbalTest;
	...
	@FindAll(@FindBy(how = How.XPATH, using = "//div//h3[text()='Verbal Test']/following-sibling::div//a//div"))
    private List<WebElement> elements;

	
	
	public void clickVerbalTest() throws Exception
	{
		Thread.sleep(1500);
		VerbalTest.click();
	}
