...
public class Angular8QuizPage {
	
WebDriver ldriver;
	
	public Angular8QuizPage(WebDriver rdriver)
	{
		ldriver = rdriver;
	...
	@FindBy(how=How.XPATH, using ="//a[contains(@href,'#Angular-8')]")
	WebElement Angular8Test;
	...
	@FindAll(@FindBy(how = How.XPATH, using = "//div//h3[text()='Angular-8']/following-sibling::div//a//div"))
    private List<WebElement> elements;

	
	
	public void clickAngular8Test() throws Exception
	{
		Thread.sleep(1500);
		Angular8Test.click();
	}
