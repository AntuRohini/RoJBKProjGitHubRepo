...
public class TC_24_ArithmeticAptitudeQuizForAll_102025QueOptions extends BaseClass{
			     ...
			     for(int i=a;i<takeQuiz.size();i++)
			      {
				    ...
				    for(int k=b;k<radio.size();k++)
					{
						...
						test.info("Arithmetic Aptitude quiz started for "+value+" questions.");
						...
						if(value.equalsIgnoreCase("10"))
						 {
						    ...
						    System.out.println("Arithmetic Aptitude QUIZ start for 10 question: "+arithmeticquiz);
						    test.info("Arithmetic Aptitude QUIZ start for 10 question: "+arithmeticquiz);
						    ...
						    try
							{
								...
								if(error==true)
								{
									captureScreenshot(driver,arithmeticquiz+value+"_ArithmeticAptitude_NoQueFound");
							...
							}catch(Exception ElementNotInteractableException)
							{
								...
								for(int j=1;j<=num1-1;j++)
								{
								   ...
								   int numQue = Integer.parseInt(queCount);
								     if(numQue!=10)
								       {
									      captureScreenshot(driver,arithmeticquiz+"_ArithmeticAptitude_10QueQuizSubmittedFor_"+queCount+"_que");
									      test.fail("Arithmetic Aptitude Quiz submitted for less than 10 questions. No of question found: "+queCount);
				  				       }
								     else 
								       {
								          test.pass("Arithmetic Aptitude quiz Test Pass for all "+queCount+" questions")	;
								       }
								     arithmeticQuiz.closeQuizWindow();
								     Thread.sleep(1500);
						...
						if(value.equalsIgnoreCase("20"))
						 {
						    ...
						    Thread.sleep(1500);
						    String arithmeticquiz = quizName.get(i).getText();
						    System.out.println("Arithmetic Aptitude QUIZ start for 20 question: "+arithmeticquiz);
						    test.info("Arithmetic Aptitude QUIZ start for 20 question: "+arithmeticquiz);
							...
							}catch(Exception ElementNotInteractableException)
							{
								...
								for(int j=1;j<=num1-1;j++)
								{
								   ...
								   int numQue = Integer.parseInt(queCount);
								     if(numQue!=20)
								       {
									      captureScreenshot(driver,arithmeticquiz+"_ArithmeticAptitude_20QueQuizSubmittedFor_"+queCount+"_que");
									      test.fail("Arithmetic Aptitude Quiz submitted for less than 20 questions. No of question found: "+queCount);
				  				       }
								     else 
								       {
						...
						if(value.equalsIgnoreCase("25"))
						 {
						    ...
						    Thread.sleep(1500);
						    String arithmeticquiz = quizName.get(i).getText();
						    System.out.println("Arithmetic Aptitude QUIZ start for 25 question: "+arithmeticquiz);
						    test.info("Arithmetic Aptitude QUIZ start for 25 question: "+arithmeticquiz);
							...
							}catch(Exception ElementNotInteractableException)
							{
								...
								for(int j=1;j<=num1-1;j++)
								{
								   ...
								   int numQue = Integer.parseInt(queCount);
								     if(numQue!=25)
								       {
									      captureScreenshot(driver,arithmeticquiz+"_ArithmeticAptitude_25QueQuizSubmittedFor_"+queCount+"_que");
									      test.fail("Arithmetic Aptitude Quiz submitted for less than 25 questions. No of question found: "+queCount);
				  				       }
								     else 
								       {
								          test.pass("Arithmetic Aptitude Test Pass for all "+queCount+" questions")	;
