...
public class TestttttQuizPage {
	
WebDriver ldriver;
	
	public TestttttQuizPage(WebDriver rdriver)
	{
		ldriver = rdriver;
	...
	@FindBy(how=How.XPATH, using ="//a[contains(@href,'#testtttt')]")
	WebElement Testtttt;
...
//	WebElement clickRadiobtn20que;
	...
	@FindAll(@FindBy(how = How.XPATH, using = "//div//h3[text()='testtttt']/following-sibling::div//a//div"))
    private List<WebElement> elements;

	
	
	public void clickTestttttTest() throws Exception
	{
		Thread.sleep(1500);
		Testtttt.click();
	}
