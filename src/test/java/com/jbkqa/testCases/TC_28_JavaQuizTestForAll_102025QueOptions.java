...
public class TC_28_JavaQuizTestForAll_102025QueOptions extends BaseClass{
			     ...
			     for(int i=a;i<takeQuiz.size();i++)
			      {
				    ...
				    for(int k=b;k<radio.size();k++)
					{
						...
						test.info("Java quiz started for "+value+" questions.");
						...
						if(value.equalsIgnoreCase("10"))
						 {
						    ...
						    System.out.println("Java QUIZ start for 10 question: "+javaquiz);
						    test.info("Java QUIZ start for 10 question: "+javaquiz);
						    ...
						    try
							{
								...
								if(error==true)
								{
									captureScreenshot(driver,javaquiz+value+"_Java_NoQueFound");
							...
							}catch(Exception ElementNotInteractableException)
							{
								...
								for(int j=1;j<=num1-1;j++)
								{
								   ...
								   int numQue = Integer.parseInt(queCount);
								     if(numQue!=10)
								       {
									      captureScreenshot(driver,javaquiz+"_Java_10QueQuizSubmittedFor_"+queCount+"_que");
									      test.fail("Java Quiz submitted for less than 10 questions. No of question found: "+queCount);
				  				       }
								     else 
								       {
								          test.pass("Java quiz Test Pass for all "+queCount+" questions")	;
								       }
								     javaQuiz.closeQuizWindow();
								     Thread.sleep(1500);
						...
						if(value.equalsIgnoreCase("20"))
						 {
						    ...
						    Thread.sleep(1500);
						    String javaquiz = quizName.get(i).getText();
						    System.out.println("Java QUIZ start for 20 question: "+javaquiz);
						    test.info("Java QUIZ start for 20 question: "+javaquiz);
							...
							}catch(Exception ElementNotInteractableException)
							{
								...
								for(int j=1;j<=num1-1;j++)
								{
								   ...
								   int numQue = Integer.parseInt(queCount);
								     if(numQue!=20)
								       {
									      captureScreenshot(driver,javaquiz+"_Java_20QueQuizSubmittedFor_"+queCount+"_que");
									      test.fail("Java Quiz submitted for less than 20 questions. No of question found: "+queCount);
				  				       }
								     else 
								       {
						...
						if(value.equalsIgnoreCase("25"))
						 {
						    ...
						    Thread.sleep(1500);
						    String javaquiz = quizName.get(i).getText();
						    System.out.println("Java QUIZ start for 25 question: "+javaquiz);
						    test.info("Java QUIZ start for 25 question: "+javaquiz);
							...
							}catch(Exception ElementNotInteractableException)
							{
								...
								for(int j=1;j<=num1-1;j++)
								{
								   ...
								   int numQue = Integer.parseInt(queCount);
								     if(numQue!=25)
								       {
									      captureScreenshot(driver,javaquiz+"_Java_25QueQuizSubmittedFor_"+queCount+"_que");
									      test.fail("Java Quiz submitted for less than 25 questions. No of question found: "+queCount);
				  				       }
								     else 
								       {
								          test.pass("Java Test Pass for all "+queCount+" questions")	;
