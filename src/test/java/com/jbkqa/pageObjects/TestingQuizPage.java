...
public class TestingQuizPage {
	
WebDriver ldriver;
	
	public TestingQuizPage(WebDriver rdriver)
	{
		ldriver = rdriver;
	...
	@FindBy(how=How.XPATH, using ="//a[contains(@href,'#Testing')]")
	WebElement TestingTest;
	...
	@FindAll(@FindBy(how = How.XPATH, using = "//div//h3[text()='Testing']/following-sibling::div//a//div"))
    private List<WebElement> elements;

	
	
	public void clickTestingTest() throws Exception
	{
		Thread.sleep(1500);
		TestingTest.click();
	}
