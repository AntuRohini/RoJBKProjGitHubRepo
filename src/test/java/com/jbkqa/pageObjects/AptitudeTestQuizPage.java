...
public class AptitudeTestQuizPage {
	
WebDriver ldriver;
	
	public AptitudeTestQuizPage(WebDriver rdriver)
	{
		ldriver = rdriver;
	...
	@FindBy(how=How.XPATH, using ="//a[contains(@href,'#Aptitude-Test')]")
	WebElement AptitudeTest;
	...
	@FindAll(@FindBy(how = How.XPATH, using = "//div//h3[text()='Aptitude Test']/following-sibling::div//a//div"))
    private List<WebElement> elements;

	
	
	public void clickAptitudeTest() throws Exception
	{
		Thread.sleep(1500);
		AptitudeTest.click();
	}
