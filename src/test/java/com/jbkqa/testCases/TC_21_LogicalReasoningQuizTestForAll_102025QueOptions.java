...
public class TC_21_LogicalReasoningQuizTestForAll_102025QueOptions extends BaseClass{
	
	@Test
	public void LogicalReasoningQuizTest() throws Exception
	{
			     ...
			     for(int i=a;i<takeQuiz.size();i++)
			      {
				    ...
				    for(int k=b;k<radio.size();k++)
					{
						...
						test.info("Logical Reasoning quiz started for "+value+" questions.");
						...
						if(value.equalsIgnoreCase("10"))
						 {
						    ...
						    System.out.println("Logical Reasoning QUIZ start for 10 question: "+logicRquiz);
						    test.info("Logical Reasoning QUIZ start for 10 question: "+logicRquiz);
						    ...
						    try
							{
								...
								if(error==true)
								{
									captureScreenshot(driver,logicRquiz+value+"_LogicalReasoning_NoQueFound");
							...
							}catch(Exception ElementNotInteractableException)
							{
								...
								for(int j=1;j<=num1-1;j++)
								{
								   ...
								   int numQue = Integer.parseInt(queCount);
								     if(numQue!=10)
								       {
									      captureScreenshot(driver,logicRquiz+"_LogicalReasoniong_10QueQuizSubmittedFor_"+queCount+"_que");
						...
						if(value.equalsIgnoreCase("20"))
						 {
						    ...
						    Thread.sleep(1500);
						    String logicRquiz = quizName.get(i).getText();
						    System.out.println("Logical Reasoning QUIZ start for 20 question: "+logicRquiz);
						    test.info("Logical Reasoning QUIZ start for 20 question: "+logicRquiz);
							...
							}catch(Exception ElementNotInteractableException)
							{
								...
								for(int j=1;j<=num1-1;j++)
								{
								   ...
								   int numQue = Integer.parseInt(queCount);
								     if(numQue!=20)
								       {
									      captureScreenshot(driver,logicRquiz+"_LogicalReasoniong_20QueQuizSubmittedFor_"+queCount+"_que");
									      test.fail("Logical Reasoning Quiz submitted for less than 20 questions. No of question found: "+queCount);
				  				       }
								     else 
								       {
								          test.pass("Logical Reasoning Test Pass for all "+queCount+" questions")	;
						...
						if(value.equalsIgnoreCase("25"))
						 {
						    ...
						    Thread.sleep(1500);
						    String logicRquiz = quizName.get(i).getText();
						    System.out.println("Logical Reasoning QUIZ start for 25 question: "+logicRquiz);
						    test.info("Logical Reasoning QUIZ start for 25 question: "+logicRquiz);
							...
							}catch(Exception ElementNotInteractableException)
							{
								...
								for(int j=1;j<=num1-1;j++)
								{
								   ...
								   int numQue = Integer.parseInt(queCount);
								     if(numQue!=25)
								       {
									      captureScreenshot(driver,logicRquiz+"_LogicalReasoniong_25QueQuizSubmittedFor_"+queCount+"_que");
									      test.fail("Logical Reasoning Quiz submitted for less than 25 questions. No of question found: "+queCount);
				  				       }
								     else 
								       {
								          test.pass("Logical Reasoning Test Pass for all "+queCount+" questions")	;
