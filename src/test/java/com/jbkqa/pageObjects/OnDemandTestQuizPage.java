...
public class OnDemandTestQuizPage {
	
WebDriver ldriver;
	
	public OnDemandTestQuizPage(WebDriver rdriver)
	{
		ldriver = rdriver;
	...
	@FindBy(how=How.XPATH, using ="//a[contains(@href,'#On-Demand-Test')]")
	WebElement OnDemandTest;
	...
	@FindAll(@FindBy(how = How.XPATH, using = "//div//h3[text()='On Demand Test']/following-sibling::div//a//div"))
    private List<WebElement> elements;

	
	
	public void clickOnDemandTest() throws Exception
	{
		Thread.sleep(1500);
		OnDemandTest.click();
	}
