...
public class GeneralKnowledgeQuizPage {
	
WebDriver ldriver;
	
	public GeneralKnowledgeQuizPage(WebDriver rdriver)
	{
		ldriver = rdriver;
	...
	@FindBy(how=How.XPATH, using ="//a[contains(@href,'#General-Knowledge')]")
	WebElement GeneralKnowledgeTest;
	...
	@FindAll(@FindBy(how = How.XPATH, using = "//div//h3[text()='General Knowledge']/following-sibling::div//a//div"))
    private List<WebElement> elements;

	
	
	public void clickGeneralKnowledgeTest() throws Exception
	{
		Thread.sleep(1500);
		GeneralKnowledgeTest.click();
	}
