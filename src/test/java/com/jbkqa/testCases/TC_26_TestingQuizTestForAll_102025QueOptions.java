...
public class TC_26_TestingQuizTestForAll_102025QueOptions extends BaseClass{
			     ...
			     for(int i=a;i<takeQuiz.size();i++)
			      {
				    ...
				    for(int k=b;k<radio.size();k++)
					{
						...
						test.info("Testing quiz started for "+value+" questions.");
						...
						if(value.equalsIgnoreCase("10"))
						 {
						    ...
						    System.out.println("Testing QUIZ start for 10 question: "+testingquiz);
						    test.info("Testing QUIZ start for 10 question: "+testingquiz);
						    ...
						    try
							{
								...
								test.fail("Captured error text displayed for No Questions Found for "+testingquiz);
								
								
								if(error==true)
								{
									captureScreenshot(driver,testingquiz+value+"_Testing_NoQueFound");
									test.fail("Testing Quiz test failed for "+testingquiz);
							...
							}catch(Exception ElementNotInteractableException)
							{
								...
								for(int j=1;j<=num1-1;j++)
								{
								   ...
								   int numQue = Integer.parseInt(queCount);
								     if(numQue!=10)
								       {
									      captureScreenshot(driver,testingquiz+"_Testing_10QueQuizSubmittedFor_"+queCount+"_que");
									      test.fail("Testing Quiz submitted for less than 10 questions. No of question found: "+queCount);
				  				       }
								     else 
								       {
								          test.pass("Testing quiz Test Pass for all "+queCount+" questions")	;
								       }
								     TestingQuiz.closeQuizWindow();
								     Thread.sleep(1500);
						...
						if(value.equalsIgnoreCase("20"))
						 {
						    ...
						    Thread.sleep(1500);
						    String testingquiz = quizName.get(i).getText();
						    System.out.println("Testing QUIZ start for 20 question: "+testingquiz);
						    test.info("Testing QUIZ start for 20 question: "+testingquiz);
							...
							}catch(Exception ElementNotInteractableException)
							{
								...
								for(int j=1;j<=num1-1;j++)
								{
								   ...
								   int numQue = Integer.parseInt(queCount);
								     if(numQue!=20)
								       {
									      captureScreenshot(driver,testingquiz+"_Testing_20QueQuizSubmittedFor_"+queCount+"_que");
									      test.fail("Testing Quiz submitted for less than 20 questions. No of question found: "+queCount);
				  				       }
								     else 
								       {
						...
						if(value.equalsIgnoreCase("25"))
						 {
						    ...
						    Thread.sleep(1500);
						    String testingquiz = quizName.get(i).getText();
						    System.out.println("Testing QUIZ start for 25 question: "+testingquiz);
						    test.info("Testing QUIZ start for 25 question: "+testingquiz);
							...
							}catch(Exception ElementNotInteractableException)
							{
								...
								for(int j=1;j<=num1-1;j++)
								{
								   ...
								   int numQue = Integer.parseInt(queCount);
								     if(numQue!=25)
								       {
									      captureScreenshot(driver,testingquiz+"_Testing_25QueQuizSubmittedFor_"+queCount+"_que");
									      test.fail("Testing Quiz submitted for less than 25 questions. No of question found: "+queCount);
				  				       }
								     else 
								       {
