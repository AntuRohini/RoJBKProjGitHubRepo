...
public class MySQLQuizPage {
	
WebDriver ldriver;
	
	public MySQLQuizPage(WebDriver rdriver)
	{
		ldriver = rdriver;
	...
	@FindBy(how=How.XPATH, using ="//a[contains(@href,'#MySQL')]")
	WebElement MySQLTest;
	...
	@FindAll(@FindBy(how = How.XPATH, using = "//div//h3[text()='MySQL']/following-sibling::div//a//div"))
    private List<WebElement> elements;

	
	
	public void clickMySQLTest() throws Exception
	{
		Thread.sleep(1500);
		MySQLTest.click();
	}
