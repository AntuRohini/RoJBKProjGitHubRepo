...
public class JavaQuizPage {
	
WebDriver ldriver;
	
	public JavaQuizPage(WebDriver rdriver)
	{
		ldriver = rdriver;
	...
	@FindBy(how=How.XPATH, using ="//a[contains(@href,'#Java')]")
	WebElement JavaTest;
	...
	@FindAll(@FindBy(how = How.XPATH, using = "//div//h3[text()='Java']/following-sibling::div//a//div"))
    private List<WebElement> elements;

	
	
	public void clickJavaTest() throws Exception
	{
		Thread.sleep(1500);
		JavaTest.click();
	}
